...
public class BaseRecordGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        for (IntrospectedColumn introspectedColumn : introspectedColumns) {
            ...
            if ("Y".compareToIgnoreCase(ExecuteCreateModel.properties.getProperty("MakeGetSet")) == 0) {
        ...
        if ("Y".compareToIgnoreCase(ExecuteCreateModel.properties.getProperty(CompsName.MakeGetSet)) != 0) {
        ...
        if (context.getPlugins().modelBaseRecordClassGenerated(
            ...
            topLevelClass.addImportedType(ExecuteCreateModel.properties.getProperty(CompsName.DBModelRootClassFullPath));
